...
export const games: Game[] = [
  {
    ...
    img: "https://m.media-amazon.com/images/I/61tsILN8rBL._AC_UF1000,1000_QL80_.jpg",
    rate: 9.5
  },
  {
  ...
  {
    name: 'Divinity 2',
    quote: "I'll yield to none.",
    img: 'https://m.media-amazon.com/images/I/71r8+0hgoWL._AC_UF894,1000_QL80_.jpg',
    rate: 7.5
  },
  {
    name: 'Cyberpunk 2077',
    quote: 'In Night City, you can be whoever you want to be.',
  ...
  {
    name: 'God of War',
    quote: "1. Don't be sorry. Be better.",
    img: 'https://upload.wikimedia.org/wikipedia/en/a/a7/God_of_War_4_cover.jpg',
    rate: 8
  },
  {
    name: 'Diablo 3',
    quote: 'Look upon the Lords of Hell, and know your folly.',
